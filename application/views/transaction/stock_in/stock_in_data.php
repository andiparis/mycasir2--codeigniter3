			...
			<div class="col-md-12">
				<div class="card card-primary card-outline">
					<div class="card-header">
						<h3 class="card-title"><b>Data Stock In</b></h3>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center" width="160px">
										...
										<a href="<?=site_url('stock/in/delete/'.$data->stock_id.'/'.$data->item_id)?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-danger btn-xs">
